#region Header
// RevitWebcam/WebcamEvent.cs - a Revit external event wraping a webcam image update
//
...
{
  class WebcamEvent : IExternalEventHandler
  {
    #region Member data
    /// <summary>
    ...
    public static void Start( View view, Reference r )
    {
      ...
      _event = ExternalEvent.Create( new WebcamEvent() );
