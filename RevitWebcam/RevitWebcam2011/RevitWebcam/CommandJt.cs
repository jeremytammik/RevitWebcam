...
namespace RevitWebcam
{
  ...
  public class Command : IExternalCommand
  {
    ...
    //const string _url = "http://cameras.camvista.com/webcams/cam2_Piccadilly.jpg"; // picadilly circus
    const string _url = "http://nsx2.nvfast.org/video/a1_04.jpg"; // las vegas boulevard and convention center drive, accessed via http://www.8newsnow.com/category/8022/las-vegas-city-cams?redirected=true
