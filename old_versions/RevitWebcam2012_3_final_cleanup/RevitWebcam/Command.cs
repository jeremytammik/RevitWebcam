...
namespace RevitWebcam
{
  ...
  public class Command : IExternalCommand
  {
    ...
    static DateTime _lastUpdate 
      = DateTime.Now.Subtract( _interval );

    /// <summary>
    /// Id of user selected element to display image onto.
    /// </summary>
    static ElementId _elementId = null;
      ...
      ElementSet elements )
    {
      try
      {
        ...
        //  "expected non-null element from PickObject" ); // 2011

        //Debug.Assert( null != r.GeometryObject,
        //  "expected non-null geometry object from PickObject" ); // 2011

        Debug.Assert( null != doc.get_Element( _elementId ),
          "expected valid element from PickObject" ); // 2012

        Debug.Assert( null != doc.get_Element( _elementId )
          .GetGeometryObjectFromReference( 
            _faceReference ) as Face,
          "expected non-null geometry object from PickObject" ); // 2012
...
// C:\tmp\wall.rvt
// C:\a\lib\revit\2012\SDK\Samples\AnalysisVisualizationFramework\DistanceToSurfaces\DistanceToSurfaces.rvt
// C:\a\lib\revit\2012\SDK\Samples\AnalysisVisualizationFramework\DistanceToSurfaces\DistanceToSurfacesWebcam.rvt
// C:\a\lib\revit\2012\SDK\Samples\AnalysisVisualizationFramework\SpatialFieldGradient\SpatialFieldGradient.rvt
