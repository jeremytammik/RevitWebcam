...
namespace RevitWebcam
{
  ...
  public class Command : IExternalCommand
  {
    ...
    /// <summary>
    /// Control whether the Idling event is raised 
    /// immediately again after the last call (true), 
    /// or only once each time a new Idling session 
    /// begins (false).
    /// </summary>
    static bool _raise_without_delay
      = false;
      ...
      ElementSet elements )
    {
      try
      {
        ...
        Debug.Assert( null != doc.GetElement( _elementId ),
